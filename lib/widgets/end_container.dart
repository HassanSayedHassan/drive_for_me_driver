...
class EndContainer extends StatefulWidget {
  final Address ? picKUpLocation,dropOffLocation;
  final String arriveDuration;
  final  RequestModel? requestModel;
  EndContainer(this.picKUpLocation,this.dropOffLocation,this.arriveDuration,this.requestModel);

  @override
  _EndContainerState createState() => _EndContainerState();
}

class _EndContainerState extends State<EndContainer> {
          ...
          child: Column(
            children: [
             ...
             // SizedBox(height: 10.h,),
              ...
              Row(
                children: [
                  ...
                  Column(
                    ...
                    children: [
                      Text(
                        widget.dropOffLocation!.placeName!,
                        style: TextStyle(
                            fontSize: 22.sp,
                            color: MyTheme(context).textColor,
                            fontWeight: FontWeight.bold),
                      ...
                      Text(
                        widget.dropOffLocation!.placeFormattedAddress!.length>35?
                        widget.dropOffLocation!.placeFormattedAddress!.substring(0,35)+"....":
                        widget.dropOffLocation!.placeFormattedAddress!,
                        textAlign: TextAlign.left,
                        style: TextStyle(
                            fontSize: 16.sp,
                            color: Colors.grey,
              ...
              drowButton(text: 'End',onTab: (){

               FireBaseApi(context).driverEndFun(widget.requestModel!);
              }),
