...
class GoingToPickup extends StatefulWidget {
  final  RequestModel? requestModel;
  GoingToPickup(this.requestModel);

  @override
  _GoingToPickupState createState() => _GoingToPickupState();
}

class _GoingToPickupState extends State<GoingToPickup> {
 ...
 late LatLng  myPosition;
        ...
        children: [
          GoogleMap(
            ...
            onMapCreated: (GoogleMapController controller) async {
             ...
             //   print("afterrrrrrrr ${myPosition.longitude}");
            //    print("afterrrrrrrr ${myPosition.latitude}");
              ...
              print("getDriveLiveLocation in map  ");
              print("getDriveLiveLocation  in map ${myPosition.latitude} ");
          ...
          ArriveContainer(widget.requestModel!.pickUpLocation!,widget.requestModel!.dropOffLocation!,durationRide,widget.requestModel)
        ],
      ),
    );
  }

  Future<void> getDriveLiveLocation() async
  {

    LatLng oldPos=LatLng(0,0);
    FirebaseDatabase.instance.reference().child('driversLocation').child(widget.requestModel!.driverModel!.id!).onValue.listen((event) async {
      Map data = event.snapshot.value;
      double myLatitude=data["latitude"];
      double myLongitude=data["longitude"];
      print("myCurrent ${myLatitude}");
      print("myCurrent ${myLongitude}");
      ...
      if(!polyLineDrown)
        {
          polyLineDrown=true;
          LatLng pickUpLatLang =LatLng(widget.requestModel!.pickUpLocation!.latitude!,widget.requestModel!.pickUpLocation!.longitude!);
          await  getPlaceDirection(myPosition,pickUpLatLang);
        }



      print("afterrrrrrr2 ${myPosition.longitude}");
      print("afterrrrrrr2 ${myPosition.latitude}");
  ...
  Future<void> getPlaceDirection(LatLng picUpLatLang, LatLng dropOffLatLang) async {
    ...
    print("getPlaceDirection func");
    print("getPlaceDirection ${picUpLatLang.latitude}  ${dropOffLatLang.longitude}");
...
/*  Future<void> getPlaceDirection() async {
    var initialPosition =widget.requestModel!.pickUpLocation!;
    var finalPosition = widget.requestModel!.dropOffLocation!;
